...
function CartModal() {
  ...
  return (
    <dialog
      id="cart_modal"
      className="modal fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[75vw] h-[80vh] overflow-y-auto"
    >
      <div className="modal-box p-5 w-full max-w-3xl"> {/* Added max-w-3xl to modal-box */}
        <button
        ...
        {cart.length === 0 ? (<div className="w-[70vw] flex justify-center items-center h-[80vh]">
          <EmptyCart /> 
          </div>
          ): (
        <div className="w-[70vw]">
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table className="w-full text-sm text-left rtl:text-right text-gray-500">
              <thead className="text-xs text-gray-700 uppercase bg-gray-50 ">
                <tr>
                  <th scope="col" className="px-16 py-1 pl-4">
                    תמונה
                  </th>
                  ...
                  <th scope="col" className="px-6 py-1 pl-20">
                    כמות
                  </th>
                  <th scope="col" className="px-6 py-3">
                    מחיר
          ...
          <div>
            <hr />
            <p className="text-xl font-medium ">₪מחיר סופי:  {totalPrice} </p>
